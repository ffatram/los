                            ...
                            ?>
                                ...
                                <div class="col-6" style="margin-top: 100px;">
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-danger mr-3" style="font-size: 20px;">Ajukan Kembali</button>
                                        <button class="btn btn-primary" style="font-size: 20px;">Lanjutkan Keputusan</button>
                                    </div>
                                </div>

                            <?php
                            } else if ($data['hitung_jumlah_komite'] >= (int)$batas_komite) {
                            ?>
