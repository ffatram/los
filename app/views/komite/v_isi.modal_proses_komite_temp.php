        ...
        <div class="row mt-3">
            ...
            <div class="col-12">
                ...
                <ul class="nav nav-tabs mt-2 justify-content-center " id="" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="" data-toggle="tab" href="#d">Rekomendasi Komite</a>
                    </li>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <table cellpadding=5 cellspacing=15 id='tabel_modal'>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if ($data['detail']['plafond_dimohon'] == $data_tbl_komite[$a - 1]['plafond']) {
                    ...
                    <div class="tab-pane" id="e">
                        <div class="row mt-3">
                            ...
                            ?>
                                    ...
                                    <div class="card center">
                                        ...
                                        <div class="card-body">
                                            <table cellpadding=5 cellspacing=15 id='tabel_modal'>
                                                ...
                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Suku Bunga </td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['suku_bunga'] ?></td>
                                                </tr>


                                                <tr>
                                                    <td id='td_tabel_modal_ket'>OS Sebelumnya </td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['os_sebelumnya'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Penambahan </td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['penambahan'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Angsuran Perulan </td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['angsuran_perbulan'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Biaya Provisi Nominal </td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['biaya_provisi_nominal'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Biaya Administrasi Nominal </td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['biaya_administrasi_nominal'] ?></td>
                                                </tr>

                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Premi Asuransi </td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['premi_asuransi'] ?></td>
                                                </tr>

                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Tabungan</td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['tabungan'] ?></td>
                                                </tr>

                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Biaya Notaris</td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['biaya_notaris'] ?></td>
                                                </tr>

                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Biaya Materai</td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['biaya_materai'] ?></td>
                                                </tr>

                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Asuransi Kerugian</td>
                                                    <td id='td_tabel_modal'><?= $data_tbl_keputusan_komite['asuransi_kerugian'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td id='td_tabel_modal_ket'>Tanggal Create</td>
                                                    <td id='td_tabel_modal'><?= isset($data_tbl_keputusan_komite['tgl_create']) ? date('d-m-Y', strtotime($data_tbl_keputusan_komite['tgl_create'])) : ''   ?></td>
                                                </tr>
                                ...
                                if ($data['hitung_jumlah_komite'] >= (int)$batas_komite) {
                                ...
                                ?>
                                    ...
                                    <div class="col-6 mt-5">
                                        <div class="label text-center">
                                            <h1><b style="background-color: blue; color:white; ">DISETUJUI</b></h1>
                                        </div>
                                    </div>
                            ...
                            <?php } else { ?>
                                ...
                                ?>
                                    ...
                                    <div class="col-6 mt-5">
                                        <div class="label text-center">
                                            <h1><b style="background-color: red; color:white; ">DITOLAK</b></h1>
                                        </div>
                                    </div>
