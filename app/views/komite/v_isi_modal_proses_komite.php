                            ...
                            <div class="row">
                                    ...
                                    <table class="table table-bordered  table-hover">
                                        <thead>
                                            <tr class='text-center font-weight-bold'>
                                                <td scope="col" id='td_tabel_modal_ket_head'>Aspek</td>
                                                <td scope="col" id='td_tabel_modal_ket_head'>Usulan Analis</td>
                                                <td scope="col" id='td_tabel_modal_ket_head'>Persetujuan</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class='noPadding'>
                                                ...
                                                <td id='td_tabel_modal_2'><input type="text" name='plafond' class="form-control no" onkeypress="return hanyaAngka(event)" id='plafond' value="<?= $detail['plafond']  ?> "></td>
                                            </tr>

                                            <tr class='noPadding'>
                                                <td id='td_tabel_modal_ket_2'>Jangka Waktu (Bulan)</td>
                                                <td id='td_tabel_modal_2'><?= $detail['jangka_waktu']  ?></td>
                                                <td id='td_tabel_modal_2'><input type="text" name='jangka_waktu' class="form-control" id='jangka_waktu' onkeypress="return hanyaAngka(event)" value='<?= $data_tbl_wawancara['jangka_waktu']  ?>'></td>
                                            </tr>

                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Suku Bunga</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['suku_bunga'] ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>

                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Penambahan</td>
                                                <td id='td_tabel_modal_2'><?= number_format(($data_tbl_wawancara['penambahan']), 0, ',', '.')  ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Provisi Kredit</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['biaya_provisi_nominal']  ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Administrasi Kredit</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['biaya_administrasi_nominal'] ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Angsuran Perbulan</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['angsuran_perbulan']  ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Premi Asuransi </td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['premi_asuransi'] ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Tabungan</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['tabungan']  ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Biaya Notaris</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['biaya_notaris']  ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Biaya APHT</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['biaya_apht']   ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                            <tr>
                                                <td id='td_tabel_modal_ket_2'>Asuransi Kerugian</td>
                                                <td id='td_tabel_modal_2'><?= $data_tbl_wawancara['asuransi_kerugian'] ?> </td>
                                                <td id='td_tabel_modal_2'></td>
                                            </tr>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-3">
                                            <a href="#modal_approve" data-action="Approve" class='btn btn_proses_approve1 btn-lg btn-primary p-3 btn-block' data-no_permohonan_kredit="<?= $data_tbl_wawancara['no_permohonan_kredit'] ?>" data-no_permohonan_kredit2="<?= $data_tbl_wawancara['no_permohonan_kredit'] ?>" data-nama_pemohon="<?= $data_tbl_wawancara['nama_pemohon'] ?>" data-nama_instansi="<?= $data_tbl_wawancara['nama_instansi'] ?>" data-plafond-usulan="<?= $data_tbl_wawancara['plafond'] ?>" data-suku_bunga='<?= $data_tbl_wawancara['suku_bunga'] ?>' data-penambahan='<?= $data_tbl_wawancara['penambahan'] ?>' data-provisi_kredit='<?= $data_tbl_wawancara['biaya_provisi_nominal'] ?>' data-administrasi_kredit='<?= $data_tbl_wawancara['biaya_administrasi_nominal'] ?>' data-angsuran_perbulan='<?= $data_tbl_wawancara['angsuran_perbulan'] ?>' data-premi_asuransi='<?= $data_tbl_wawancara['premi_asuransi'] ?>' data-tabungan='<?= $data_tbl_wawancara['tabungan'] ?>' data-biaya_notaris='<?= $data_tbl_wawancara['biaya_notaris'] ?>' data-biaya_apht=<?= $data_tbl_wawancara['biaya_apht'] ?> data-asuransi_kerugian=<?= $data_tbl_wawancara['asuransi_kerugian'] ?> data-backdrop="static" data-keyboard="false">Approve </a>
                                        </div>
                                        <div class="col-3">

                                            <a href="#modal_approve" data-action="Reject" class='btn btn_proses_approve1 btn-lg btn-danger p-3 btn-block' data-no_permohonan_kredit="<?= $data_tbl_wawancara['no_permohonan_kredit'] ?>" data-no_permohonan_kredit2="<?= $data_tbl_wawancara['no_permohonan_kredit'] ?>" data-nama_pemohon="<?= $data_tbl_wawancara['nama_pemohon'] ?>" data-nama_instansi="<?= $data_tbl_wawancara['nama_instansi'] ?>" data-plafond-usulan="<?= $data_tbl_wawancara['plafond'] ?>" data-suku_bunga='<?= $data_tbl_wawancara['suku_bunga'] ?>' data-penambahan='<?= $data_tbl_wawancara['penambahan'] ?>' data-provisi_kredit='<?= $data_tbl_wawancara['biaya_provisi_nominal'] ?>' data-administrasi_kredit='<?= $data_tbl_wawancara['biaya_administrasi_nominal'] ?>' data-angsuran_perbulan='<?= $data_tbl_wawancara['angsuran_perbulan'] ?>' data-premi_asuransi='<?= $data_tbl_wawancara['premi_asuransi'] ?>' data-tabungan='<?= $data_tbl_wawancara['tabungan'] ?>' data-biaya_notaris='<?= $data_tbl_wawancara['biaya_notaris'] ?>' data-biaya_apht=<?= $data_tbl_wawancara['biaya_apht'] ?> data-asuransi_kerugian=<?= $data_tbl_wawancara['asuransi_kerugian'] ?> data-backdrop="static" data-keyboard="false">Reject</a>
                                        </div>
                                        <div class="col-3">

                                            <a href="#modal_approve" data-action="Pending" class='btn btn_proses_approve1 btn-lg btn-info p-3 btn-block' data-no_permohonan_kredit="<?= $data_tbl_wawancara['no_permohonan_kredit'] ?>" data-no_permohonan_kredit2="<?= $data_tbl_wawancara['no_permohonan_kredit'] ?>" data-nama_pemohon="<?= $data_tbl_wawancara['nama_pemohon'] ?>" data-nama_instansi="<?= $data_tbl_wawancara['nama_instansi'] ?>" data-plafond-usulan="<?= $data_tbl_wawancara['plafond'] ?>" data-suku_bunga='<?= $data_tbl_wawancara['suku_bunga'] ?>' data-penambahan='<?= $data_tbl_wawancara['penambahan'] ?>' data-provisi_kredit='<?= $data_tbl_wawancara['biaya_provisi_nominal'] ?>' data-administrasi_kredit='<?= $data_tbl_wawancara['biaya_administrasi_nominal'] ?>' data-angsuran_perbulan='<?= $data_tbl_wawancara['angsuran_perbulan'] ?>' data-premi_asuransi='<?= $data_tbl_wawancara['premi_asuransi'] ?>' data-tabungan='<?= $data_tbl_wawancara['tabungan'] ?>' data-biaya_notaris='<?= $data_tbl_wawancara['biaya_notaris'] ?>' data-biaya_apht=<?= $data_tbl_wawancara['biaya_apht'] ?> data-asuransi_kerugian=<?= $data_tbl_wawancara['asuransi_kerugian'] ?> data-backdrop="static" data-keyboard="false">Pending</a>
...
<script>
    $('.btn_proses_approve1').on('click', function(e) {
        if ($('#dasar_pertimbangan_analis').val() != '') {
            ...
            // Mengubah kelas tombol "submit_pin" sesuai dengan tindakan
            $('.btn_proses_approve2').removeClass('btn-primary btn-danger btn-info'); // Hapus kelas warna sebelumnya
            if (action === 'Approve') {
                $('.btn_proses_approve2').addClass('btn-primary');
            } else if (action === 'Reject') {
                $('.btn_proses_approve2').addClass('btn-danger');
            } else if (action === 'Pending') {
                $('.btn_proses_approve2').addClass('btn-info');
            }
