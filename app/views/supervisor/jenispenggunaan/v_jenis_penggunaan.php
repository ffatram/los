...
<body class="hold-transition sidebar-mini layout-fixed">
                                            ...
                                            <div class="card-body table-responsive p-0">
                                                ...
                                                <table id="example1" class="table table-head-fixed table-striped text-nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?= $i['kode_jenis_penggunaan'] ?></td>
                                                                <td><?= $i['jenis_penggunaan'] ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['jenis_penggunaan'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
    ...
    <script>
        var tbl = "tbl_ref_jenis_penggunaan";
        var kolom1 = "kode_jenis_penggunaan";
        var kolom2 = "jenis_penggunaan";
    </script>
        ...
        $('.btn-edit').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#id').val(i.id);
                    $('[id=data1]').val(i.kode_jenis_penggunaan);
                    $('[id=data2]').val(i.jenis_penggunaan);
