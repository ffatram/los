...
<body class="hold-transition sidebar-mini layout-fixed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['nama_fasilitas'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
    ...
    <script>
        $('#myformtambah').on('submit', function(e) {
            ...
            e.preventDefault()
            var ajax_cek_data = ajax_cek('/supervisor/get_cek_data_nama_fasilitas', myform)
            ...
            if (ajax_cek_data == "gagal") {
                ...
                Swal.fire({
                    ...
                    if (respon.isConfirmed) {
                        ...
                        var ajax_simpan_data = ajax_cek('/supervisor/fasilitas_kredit_tambah', myform)
    ...
    <script>
        $('.btn-edit').on('click', function() {
            ...
            console.log('id : ' + id)
            $.ajax({
                url: '<?= BASEURL ?>/supervisor/get_data_faslitas_kredit_edit_id',
                type: 'post',
                data: {
                    id: id
                },
            ...
            if (cek_form == "sama") {
                ...
                if (ajax_cek_data == "sukses") {
                    ...
                    Swal.fire({
                        ...
                        if (respon.isConfirmed) {
                            var hasil = ajax_cek("/supervisor/fasilitas_kredit_update", myform);
        ...
        $('.btn-hapus').on('click', function() {
            ...
            Swal.fire({
                ...
                if (respon.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= BASEURL . '/supervisor/fasilitas_kredit_hapus' ?>',
                        data: {
                            id: id
                        },
                        success: function(res) {
