...
<body class="hold-transition sidebar-mini layout-fixed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['jenis_kredit'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
    ...
    <script>
        var tbl = "tbl_ref_jenis_kredit";
        var kolom1 = "jenis_kredit";
    </script>
