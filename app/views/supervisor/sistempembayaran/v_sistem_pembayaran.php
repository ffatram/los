...
<body class="hold-transition sidebar-mini layout-fixed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['sistem_pembayaran'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
    ...
    <script>
        var tbl = "tbl_ref_sistem_pembayaran";
        var kolom1 = "sistem_pembayaran";
    </script>
    ...
    <script>
        $('#myformtambah').on('submit', function(e) {
            ...
            var myform = $('#myformtambah').serialize() + "&tbl=" + tbl + "&kolom1=" + kolom1;
            e.preventDefault()
            ...
            if (ajax_cek_data == "gagal") {
                ...
                Swal.fire({
                    ...
                    if (respon.isConfirmed) {
                        ...
                        var ajax_simpan_data = ajax_cek('/supervisor/data_ref_all_one_kolom_tambah', myform)
        ...
        $('.btn-edit').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#id').val(i.id);
                    $('[id=data1]').val(i.sistem_pembayaran);
    ...
    <script>
        ...
        $('#myformedit').on('submit', function(e) {
            var myform = $('#myformedit').serialize() + "&tbl=" + tbl + "&kolom1=" + kolom1;
            e.preventDefault()
                ...
                if (ajax_cek_data == "sukses") {
                    ...
                    if (data1 != $('#data1').val()) {
                        ...
                        Swal.fire({
                            ...
                            if (respon.isConfirmed) {
                                var hasil = ajax_cek("/supervisor/data_ref_all_one_kolom_update", myform);
