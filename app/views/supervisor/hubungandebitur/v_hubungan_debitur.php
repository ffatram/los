...
<body class="hold-transition sidebar-mini layout-fixed">
                                            ...
                                            <div class="card-body table-responsive p-0">
                                                ...
                                                <table id="example1" class="table table-head-fixed table-striped text-nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?= $i['kode_hubungan_debitur_dengan_bank'] ?></td>
                                                                <td><?= $i['hubungan_debitur_dengan_bank'] ?></td>

                                                                <td>

                                                                    <div class="text-center">
                                                                        <button type="button" class="btn btn-primary btn-sm btn-edit" data-id="<?= $i['id'] ?>" title="Edit"><i class="fas fa-edit"></i></button>
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['hubungan_debitur_dengan_bank'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
    ...
    <script>
        $('#myformtambah').on('submit', function(e) {
            ...
            e.preventDefault()
            var ajax_cek_data = ajax_cek('/supervisor/get_cek_data_hubungan_debitur', myform)
            ...
            if (ajax_cek_data == "gagal") {
                ...
                Swal.fire({
                    ...
                    if (respon.isConfirmed) {
                        ...
                        var ajax_simpan_data = ajax_cek('/supervisor/hubungan_debitur_tambah', myform)
    ...
    <script>
        $('.btn-edit').on('click', function() {
            ...
            console.log('id : ' + id)
            $.ajax({
                url: '<?= BASEURL ?>/supervisor/get_data_hubungan_debitur_edit_id',
                type: 'post',
                data: {
                    id: id
                },
                success: function(data) {
                    ...
                    $('#id').val(i.id);
                    $('[id=data1]').val(i.kode_hubungan_debitur_dengan_bank);
                    $('[id=data2]').val(i.hubungan_debitur_dengan_bank);
                ...
                if (ajax_cek_data == "sukses") {
                    ...
                    if (data1 != $('#data1').val()) {
                        ...
                        Swal.fire({
                            ...
                            if (respon.isConfirmed) {
                                var hasil = ajax_cek("/supervisor/hubungan_debitur_update", myform);
        ...
        $('.btn-hapus').on('click', function() {
            ...
            Swal.fire({
                ...
                if (respon.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= BASEURL . '/supervisor/hubungan_debitur_hapus' ?>',
                        data: {
                            id: id
                        },
                        success: function(res) {
