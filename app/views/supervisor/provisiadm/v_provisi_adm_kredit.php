...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        $('.btn-edit').on('click', function() {
            ...
            console.log('id : ' + id)
            $.ajax({
                url: '<?= BASEURL ?>/supervisor/get_provisiadm_edit_id',
                type: 'post',
                data: {
                    id: id
                },
                success: function(data) {
                    ...
                    $('#id').val(i.id);
                    $('[id=data1]').val(i.provisi);
                    $('[id=data2]').val(i.administrasi);
            ...
            if (cek_form == "sama") {
                ...
                Swal.fire({
                    ...
                    if (respon.isConfirmed) {
                        var hasil = ajax_cek("/supervisor/provisiadm_update", myform);
