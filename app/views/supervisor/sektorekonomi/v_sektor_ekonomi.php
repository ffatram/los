...
<body class="hold-transition sidebar-mini layout-fixed">
                                            ...
                                            <div class="card-body table-responsive p-0">
                                                ...
                                                <table id="example1" class="table table-head-fixed table-striped text-nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?= $i['kode_sektor_ekonomi'] ?></td>
                                                                <td><?= $i['sektor_ekonomi'] ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['sektor_ekonomi'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
                        ...
                        <div class="col-12">
                            <form id="myformtambah">
                                <div class="form-group">
                                    <label>Kode Sektor Ekonomi</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form id="myformedit">
                                ...
                                <div class="form-group">
                                    <label>Kode Jenis Penggunaan</label>
    ...
    <script>
        var tbl = "tbl_ref_sektor_ekonomi";
        var kolom1 = "kode_sektor_ekonomi";
        var kolom2 = "sektor_ekonomi";
    </script>
    ...
    <script>
        $('#myformtambah').on('submit', function(e) {
            ...
            var myform = $('#myformtambah').serialize() + "&tbl=" + tbl + "&kolom1=" + kolom1 + "&kolom2=" + kolom2;
            e.preventDefault()
            ...
            if (ajax_cek_data == "gagal") {
                ...
                Swal.fire({
                    ...
                    if (respon.isConfirmed) {
                        ...
                        var ajax_simpan_data = ajax_cek('/supervisor/data_ref_all_2_kolom_tambah', myform)
        ...
        $('.btn-edit').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#id').val(i.id);
                    $('[id=data1]').val(i.kode_sektor_ekonomi);
                    $('[id=data2]').val(i.sektor_ekonomi);
    ...
    <script>
        ...
        $('#myformedit').on('submit', function(e) {
            var myform = $('#myformedit').serialize() + "&tbl=" + tbl + "&kolom1=" + kolom1 + "&kolom2=" + kolom2;
            e.preventDefault()
            ...
            if (cek_form == "sama") {
                ...
                if (data1 == $('#data1').val()) {
                    Swal.fire({
                        ...
                        if (respon.isConfirmed) {
                            var hasil = ajax_cek("/supervisor/data_ref_all_2_kolom_update", myform);
