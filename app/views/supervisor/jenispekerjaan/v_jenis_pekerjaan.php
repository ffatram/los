...
<body class="hold-transition sidebar-mini layout-fixed">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $i['surat_kuasa_pencairan'] ?></td>
                                                                <td><?= $i['checklist_berkas'] ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['jenis_pekerjaan'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form id="myformtambah">
                                ...
                                <div class="form-group">
                                    <label>Checklist Berkas</label>
                                    <select name="data3" class="form-control">
                                        <option value="" selected="true" disabled="disabled">- Silahkan Pilih -</option>
                                        <?php
                                        foreach ($data['data3'] as $i) {
                                        ?>
                                            <option value="<?= $i ?>"><?= $i ?></option>
    ...
    <script>
        var tbl = "tbl_ref_jenis_pekerjaan";
        var kolom1 = "jenis_pekerjaan";
        var kolom2 = "surat_kuasa_pencairan";
        var kolom3 = "checklist_berkas";
    </script>
    ...
    <script>
        $('#myformtambah').on('submit', function(e) {
            ...
            var myform = $('#myformtambah').serialize() + "&tbl=" + tbl + "&kolom1=" + kolom1 + "&kolom2=" + kolom2 + "&kolom3=" + kolom3;
            e.preventDefault()
            var ajax_cek_data = ajax_cek('/supervisor/get_cek_data_ref_all_one_kolom', myform)
            ...
            if (ajax_cek_data == "gagal") {
                ...
                Swal.fire({
                    ...
                    if (respon.isConfirmed) {
                        ...
                        var ajax_simpan_data = ajax_cek('/supervisor/data_ref_all_3_kolom_tambah', myform)

                        console.log("Cek : " + ajax_simpan_data)
    ...
    <script>
        $('.btn-edit').on('click', function() {
            ...
            console.log('id : ' + id)
            $.ajax({
                url: '<?= BASEURL ?>/supervisor/get_data_ref_all_edit_id',
                type: 'post',
                data: {
                    tbl: tbl,
                    id: id
                ...
                success: function(data) {
                    ...
                    $('#id').val(i.id);
                    $('[id=data1]').val(i.jenis_pekerjaan);
                    $('[id=data2]').val(i.surat_kuasa_pencairan);
                    $('[id=data3]').val(i.checklist_berkas);
    ...
    <script>
        ...
        $('#myformedit').on('submit', function(e) {
            var myform = $('#myformedit').serialize() + "&tbl=" + tbl + "&kolom1=" + kolom1 + "&kolom2=" + kolom2 + "&kolom3=" + kolom3;
            e.preventDefault()

            console.log("cek form : " + cek_form)
            ...
            if (cek_form == "sama") {
                ...
                if (data1 == $('#data1').val()) {
                    Swal.fire({
                        ...
                        if (respon.isConfirmed) {
                            var hasil = ajax_cek("/supervisor/data_ref_all_3_kolom_update", myform);
        ...
        $('.btn-hapus').on('click', function() {
            ...
            Swal.fire({
                ...
                if (respon.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= BASEURL . '/supervisor/data_ref_all_one_kolom_hapus' ?>',
                        data: {
                            tbl: tbl,
                            id: id
                        },
