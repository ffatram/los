...
<body class="hold-transition sidebar-mini layout-fixed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['nama_marketing'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
    ...
    <script>
        var tbl = "tbl_ref_marketing";
        var kolom1 = "nama_marketing";
        var kolom2 = "kode_cabang";
    </script>
        ...
        $('.btn-edit').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#id').val(i.id);
                    $('[id=data1]').val(i.nama_marketing);
                    $('[id=data2]').val(i.kode_cabang);
