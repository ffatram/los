...
<body class="hold-transition sidebar-mini layout-fixed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?= $i['id'] ?>" data-data1="<?= $i['nama_jaminan'] ?>" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                                                    </div>
    ...
    <script>
        $('#myformtambah').on('submit', function(e) {
            ...
            var myform = $('#myformtambah').serialize() + "&tbl=" + "tbl_ref_jaminan" + "&kolom1=" + "nama_jaminan";
            e.preventDefault()
    ...
    <script>
        ...
        $('#myformedit').on('submit', function(e) {
            var myform = $('#myformedit').serialize() + "&tbl=" + "tbl_ref_jaminan" + "&kolom1=" + "nama_jaminan";
            e.preventDefault()
