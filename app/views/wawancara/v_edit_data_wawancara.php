...
<body class="hold-transition sidebar-mini layout-fixed">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-auto p-1">
                                                        <div class="d-flex">
                                                            <span class="mr-1">
                                                                <div class="btn btn-sm bg-success" id="btn_modal_upload_file" data-toggle="modal" data-target="#modal_upload_file" data-no_permohonan_kredit="<?= $data['data_wawancara']['no_permohonan_kredit']  ?>">Upload File</div>
                                                            </span>
                                                            <span class="mr-1">
                                                                <div><button style="background-color: <?= w_orange ?>; color:white; " type="button" class="btn btn-sm" id="btn_modal_detail" data-toggle="modal" data-target="#modal_detail" data-no_permohonan_kredit="<?= $data['data_cs']['no_permohonan_kredit'] ?>">Detail Permohonan</button></div>
                                                            </span>

                                                            <span>
                                                                <div><button style="background-color: <?= w_orange ?>; color:white; " type="button" class="btn btn-sm  detail_slik" data-toggle="modal" data-target="#detail_slik" data-no_permohonan_kredit="<?= $data['data_cs']['no_permohonan_kredit']  ?>">Detail SLIK</button></div>
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane active" id="tab-wawancara-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-6 col-xxl-6 ">
                                                                ...
                                                                <input type="text" id="biaya_provisi_nominal" name="biaya_provisi_nominal" class="form-control biaya_provisi_nominal" onkeypress="return hanyaAngka(event)" value="<?= number_format(($data['data_wawancara']['biaya_provisi_nominal']), 0, ',', '.') ?>" />
                                                                ...
                                                                <input type="text" id="biaya_administrasi_nominal" name="biaya_administrasi_nominal" class="form-control biaya_administrasi_nominal" oninput="this.value = this.value.toUpperCase()" onkeypress="return hanyaAngka(event)" value="<?= number_format(($data['data_wawancara']['biaya_administrasi_nominal']), 0, ',', '.') ?>" />
                                                                <div class="d-flex justify-content-center mt-1" style="column-gap: 10px;">
                                                                    <div class="col-xs-0">
    ...
    <script>
        ...
        function tambahBarisKeTabel(response) {
            ...
            if (table.rows().count() > 0) {
                $("#example1__empty").hide(); // "example1_empty" adalah ID elemen pesan kosong DataTables
            }
        }
    </script>
    ...
    <script>
        ...
        $("#uploadButton").on("click", function() {
            ...
            var no_permohonan_kredit = "<?= $data['data_wawancara']['no_permohonan_kredit'] ?>"
    ...
    <script>
        ...
        // bagian untuk check bagian chelisk tolak_batal

        var tolak_permohonan = "<?= $data['data_wawancara']['tolak_batal'] ?>"
        var batal_permohonan = "<?= $data['data_wawancara']['tolak_batal'] ?>"

        if (tolak_permohonan == "TOLAK") {
            $('.tolak_permohonan').prop('checked', true);
            keterangan = "tolak";

        }


        if (batal_permohonan == "BATAL") {
            $('.batal_permohonan').prop('checked', true);
            keterangan = "batal";
        }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        data: formInput.serialize() + '&status=' + "BELUM DIAJUKAN" + '&tolak_batal=' + "TOLAK" + '&lokasi_berkas=' + "ANALISA",
                        success: function(res) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        data: formInput.serialize() + '&status=' + "BELUM DIAJUKAN" + '&tolak_batal=' + "BATAL" + '&lokasi_berkas=' + "ANALISA",
                        success: function(res) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        data: formInput.serialize() + '&status=' + "BELUM DIAJUKAN" + '&tolak_batal=' + "" + '&lokasi_berkas=' + "ANALISA",
                        success: function(res) {

                            // cek apakah hasil res memiliki nilai karakter atau tidak

                            var hasilRes = res.trim()

                            if (hasilRes == 'berhasil') {
