                                                    ...
                                                    <div class="tab-pane active" id="tab-wawancara-1">
                                                        <div class="row">
                                                                ...
                                                                <div class="">
                                                                    <div class="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="dasar_pertimbangan_analis" class="form-control h-25" rows="15" placeholder="" oninput="this.value = this.value.toUpperCase()"></textarea>
                                                            ...
                                                            <div class="col-12 col-lg-6 col-xxl-6 ">
                                                                ...
                                                                <input type="text" id="plafond" name="plafond" class="form-control plafond" value="<?= $data['data_wawancara_where_noreg']['plafond_dimohon'] ?>" />
                                                                    ...
                                                                    <div class="d-flex justify-content-center mt-1" style="column-gap: 10px;">
                                                                        ...
                                                                        <div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input type="checkbox" class="form-check-input pemohon_lunasi_<?= $a ?>" id="cek_angsuran_pemohon<?= $a ?>" name="pemohon_lunasi_<?= $a ?>">
                                                                    ...
                                                                    <div class="d-flex justify-content-center mt-1" style="column-gap: 10px;">
                                                                        ...
                                                                        <div>
                                                                            <div class="form-check form-check-inline">
                                                                                ...
                                                                                <input type="checkbox" class="form-check-input pasangan_lunasi_<?= $a ?>" id="cek_angsuran_pasangan<?= $a ?>" name="pasangan_lunasi_<?= $a ?>">
                                                    ...
                                                    <div class="tab-pane" id="tab-sandi-sandi-4">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <select name="kode_golongan_debitur" class="form-control kode_golongan_debitur">
                                                                    <option value="" required selected>- Silahkan Pilih -</option>
                                                                ...
                                                                <select name="kode_jenis_penggunaan" class="form-control kode_jenis_penggunaan">
                                                                    <option value="" required selected>- Silahkan Pilih -</option>
                                                                ...
                                                                <select name="kode_sektor_ekonomi" class="form-control kode_sektor_ekonomi">
                                                                    <option value="" required selected>- Silahkan Pilih -</option>
                                                                    <?php foreach ($data['ref_sektor_ekonomi'] as $i) : ?>
                                                                        <option value="<?= $i['kode_sektor_ekonomi'] ?>"><?php echo $i['kode_sektor_ekonomi'] . ' - ' . $i['sektor_ekonomi'] ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>


                                                                <label class="mt-2 mb-2">Hubungan Debitur Dengan Bank</label><span class="ml-1" style="color:red;">*</span>
                                                                <select name="kode_hubungan_debitur_dengan_bank" class="form-control kode_hubungan_debitur_dengan_bank">
                                                                    <option value="" required selected>- Silahkan Pilih -</option>
                    ...
                    success: function(res) {
                        ...
                        if (hasilRes == true) {
                            ...
                            Swal.fire({
                                ...
                                location.href = "<?= BASEURL ?>/wawancara/daftar_belum_wawancara";
                            })
