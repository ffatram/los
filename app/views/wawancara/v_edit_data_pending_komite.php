                                                    ...
                                                    <div class="col-4">
                                                        <table class="table-hover" cellpadding=5 cellspacing=15>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input type="hidden" name='ajukan_komite_analisa_pending' value="ajukan_komite_analisa_pending">
...
<script>
    $(document).ready(function() {
        $('#btn_update_ajukkan_komite').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    data: formInput.serialize() + '&status=' + "DIAJUKAN TOLAK" + '&lokasi_berkas=' + "KOMITE" + '&tolak_batal=' + "TOLAK",
                    success: function(res) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    data: formInput.serialize() + '&status=' + "DIAJUKAN BATAL" + '&lokasi_berkas=' + "KOMITE" + '&tolak_batal=' + "BATAL",
                    success: function(res) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    data: formInput.serialize() + '&status=' + "DIAJUKAN" + '&lokasi_berkas=' + "KOMITE" + '&tolak_batal=' + "",
                    success: function(res) {
