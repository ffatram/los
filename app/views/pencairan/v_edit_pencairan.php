...
<head>
    ...
    <title>Edit Data Pencairan</title>
...
<body>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Data Pencairan</h1>
                        </div>
                ...
                <form class="myForm">
                    ...
                    <div class="row">
                        <div class="col-12">
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control" name="nama_debitur" value="<?= $data['data']['nama_debitur'] ?>" required></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Nama Alias Debitur<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control" name='nama_alias_debitur' value="<?= $data['data']['nama_alias_debitur'] ?>" required></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tempat Lahir<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control" name="tempat_lahir_debitur" value="<?= $data['data']['tempat_lahir_debitur'] ?>" oninput="this.value = this.value.toUpperCase()" required></td>
                                                            </tr>
                                                            <tr>


                                                                <td> Tanggal Lahir<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control tgl_lahir_debitur" name="tgl_lahir_debitur" placeholder="dd/mm/yyyy" required /></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select name="jenis_kelamin_debitur" class="form-control" required>
                                                                        ...
                                                                        <option value="PRIA" <?= "PRIA" == $data['data']['jenis_kelamin_debitur'] ? 'selected="selected"' : ''; ?>><?= "PRIA" ?></option>
                                                                        <option value="WANITA" <?= "WANITA" == $data['data']['jenis_kelamin_debitur'] ? 'selected="selected"' : ''; ?>><?= "WANITA" ?></option>
                                                                ...
                                                                <td>
                                                                    <select name="jenis_pekerjaan_debitur" class="form-control" required>
                                                                        ...
                                                                        <?php foreach ($data['jenis_pekerjaan'] as $i) : ?>
                                                                            <option value="<?= $i['jenis_pekerjaan'] ?>" <?= $i['jenis_pekerjaan'] == $data['data']['jenis_pekerjaan_debitur'] ? 'selected="selected"' : ''; ?>><?= $i['jenis_pekerjaan'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select name="kode_instansi" class="form-control select2bs4 kode_instansi" required>
                                                                        ...
                                                                        <?php foreach ($data['ref_instansi'] as $i) : ?>
                                                                            ...
                                                                            <option value="<?= $i['kode_instansi'] . '##' . $i['nama_instansi'] ?>" <?= $i['kode_instansi'] == $data['data']['inkaso'] ? 'selected="selected"' : ''; ?>><?php echo $i['kode_instansi'] . ' - ' . $i['nama_instansi'] ?></option>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control nama_instansi" name='instansi_debitur' value="<?= $data['data']['instansi_debitur'] ?>" oninput="this.value = this.value.toUpperCase()" required></td>
                                                            </tr>
                                                            <tr>
                                                                <td>No. KTP<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control" name="no_ktp_debitur" value="<?= $data['data']['no_ktp_debitur'] ?>" onkeypress="return hanyaAngka(event)" maxlength="16" required></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Alamat KTP<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control" name="alamat_ktp_debitur" value="<?= $data['data']['alamat_ktp_debitur'] ?>" oninput="this.value = this.value.toUpperCase()" required></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Alamat Domisili<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control" name="alamat_domisili_debitur" value="<?= $data['data']['alamat_domisili_debitur'] ?>" oninput="this.value = this.value.toUpperCase()" required></td>
                                                            </tr>
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control" name="nama_alias_pasangan" value="<?= $data['data']['nama_alias_pasangan'] ?>"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tempat Lahir Pasangan</td>
                                                                <td><input type="text" class="form-control tempat_lahir_pasangan" name="tempat_lahir_pasangan" value="<?= $data['data']['tempat_lahir_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tgl. Lahir Pasangan</td>
                                                                <td><input type="text" class="form-control tgl_lahir_pasangan" name="tgl_lahir_pasangan" placeholder="dd/mm/yyyy"></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control" name="instansi_pasangan" value="<?= $data['data']['instansi_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()"></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control" name="alamat_domisili_pasangan" value="<?= $data['data']['alamat_domisili_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()"></td>
                                                            </tr>
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <select name="jenis_no_pk" class="form-control jenis_no_pk" required>
                                                                        ...
                                                                        <?php foreach ($data['ref_jenis_no_pk'] as $i) : ?>
                                                                            <option value="<?= $i['jenis'] ?>" <?= $i['jenis'] == $data['data']['jenis_no_pk'] ? 'selected="selected"' : ''; ?>><?= $i['jenis'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control plafond" value="<?= $data['data']['plafond'] ?>" name="plafond" onkeypress="return hanyaAngka(event)" required></td>
                                                            </tr>
                                                            <tr>
                                                                <td>OS Sebelumnya</td>
                                                                <td><input type="text" class="form-control os_sebelumnya" name="os_sebelumnya" onkeypress="return hanyaAngka(event)" value="<?= $data['data']['os_sebelumnya'] ?>"></td>
                                                            </tr>
                                                            <tr>

                                                                <?php $data['penambahan'] = ($data['data']['plafond'] - $data['data']['os_sebelumnya']) ?>
                                                                <td>Penambahan</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control jangka_waktu" name="jangka_waktu" value="<?= $data['data']['jangka_waktu'] ?>" onkeypress="return hanyaAngka(event)" required></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tgl. Mulai JW<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control tgl_mulai_jw" value="<?= $data['data']['tgl_mulai_jw'] ?>" name="tgl_mulai_jw" placeholder="dd/mm/yyyy" required></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control suku_bunga" name="suku_bunga" value="<?= $data['data']['suku_bunga'] ?>" onkeypress="return hanya_angka_decimal(event)" required></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select name="sistem_bunga" class="form-control sistem_bunga" required>
                                                                        ...
                                                                        <?php foreach ($data['ref_sistem_bunga'] as $i) : ?>
                                                                            <option value="<?= $i['sistem_bunga'] ?>" <?= $i['sistem_bunga'] == $data['data']['sistem_bunga'] ? 'selected="selected"' : ''; ?>><?= $i['sistem_bunga'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control" name="tgl_angsuran" value="<?= $data['data']['tgl_angsuran'] ?>" maxlength="2" onkeypress="return hanyaAngka(event)" required></td>
                                                            </tr>
                                                                ...
                                                                <td>
                                                                    <select name="jenis_kredit" class="form-control" required>
                                                                        ...
                                                                        <?php foreach ($data['ref_jenis_kredit'] as $i) : ?>
                                                                            <option value="<?= $i['jenis_kredit'] ?>" <?= $i['jenis_kredit'] == $data['data']['jenis_kredit'] ? 'selected="selected"' : '' ?>><?= $i['jenis_kredit'] ?></option>
                                                                        <?php endforeach; ?>

                                                                        <!-- <option value="KONSUMTIF" <?= "KONSUMTIF" == $data['data']['jenis_kredit'] ? 'selected="selected"' : ''; ?>>KONSUMTIF</option>
                                                                        <option value="MODAL KERJA" <?= "MODAL KERJA" == $data['data']['jenis_kredit'] ? 'selected="selected"' : ''; ?>>MODAL KERJA</option> -->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control" name="tujuan_penggunaan_kredit" value="<?= isset($data['data']['tujuan_penggunaan_kredit']) ? $data['data']['tujuan_penggunaan_kredit'] : '' ?>" oninput="this.value = this.value.toUpperCase()" required></td>
                                                            </tr>

                                                            <tr>
                                                                <td>No. SPPK<span class="ml-1" style="color:red;">*</span></td>
                                                                <td><input type="text" class="form-control" name="no_sppk" value="<?= $data['data']['no_sppk'] ?>" oninput="this.value = this.value.toUpperCase()" required></td>
                                                            </tr>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-center mt-1" style="column-gap: 10px;">
                                                                        ...
                                                                        <div class="col-xs-0">
                                                                            <input type="text" name="persen_provisi" onkeypress="return hanya_angka_decimal(event)" style="max-width: 80px;" class='form-control biaya_pro' value='<?= $data['data']['persen_provisi'] ?>' />
                                                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-center mt-1" style="column-gap: 10px;">
                                                                        ...
                                                                        <div class="col-xs-0">
                                                                            <input type="text" name="persen_administrasi" onkeypress="return hanya_angka_decimal(event)" style="max-width: 80px;" class='form-control biaya_adm' value='<?= $data['data']['persen_administrasi'] ?>' />
                                                                        </div>
                                                            ...
                                                            <tr>
                                                                <td>Asuransi Jiwa</td>
                                                                <td><input type="text" class="form-control asuransi_jiwa" name="asuransi_jiwa" value="<?= $data['data']['asuransi_jiwa'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Asuransi Kredit</td>
                                                                <td><input type="text" class="form-control asuransi_kredit" name="asuransi_kredit" value="<?= $data['data']['asuransi_kredit'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Asuransi Kerugian</td>
                                                                <td><input type="text" class="form-control asuransi_kerugian" name="asuransi_kerugian" value="<?= $data['data']['asuransi_kerugian'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Biaya Notaris</td>
                                                                <td><input type="text" class="form-control biaya_notaris" name="biaya_notaris" value="<?= $data['data']['biaya_notaris'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Biaya Materai</td>
                                                                <td><input type="text" class="form-control biaya_materai" name="biaya_materai" value="<?= $data['data']['biaya_materai'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Bunga Berjalan</td>
                                                                <td><input type="text" class="form-control bunga_berjalan" name="bunga_berjalan" value="<?= $data['data']['bunga_berjalan'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Tabungan SIMITRA</td>
                                                                <td><input type="text" class="form-control tabungan_simitra" name="tabungan_simitra" value="<?= $data['data']['tabungan_simitra'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Angsuran Pertama</td>
                                                                <td><input type="text" class="form-control angsuran_pertama" name="angsuran_pertama" value="<?= $data['data']['angsuran_pertama'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Denda Tunggakan (%)</td>
                                                                <td><input type="text" class="form-control denda" name="denda" value="<?= $data['data']['denda'] ?>" onkeypress="return hanyaAngka(event)"></td>
                                                            </tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select name="pejabat_ttd" class="form-control pejabat_ttd_sppk" required>
                                                                        ...
                                                                        <?php foreach ($data['ref_pejabat'] as $i) : ?>
                                                                            <option value="<?= $i['nama_pejabat'] ?>" <?= $i['nama_pejabat'] == $data['data']['pejabat_ttd'] ? 'selected="selected"' : ''; ?>><?= $i['nama_pejabat'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <select name="kode_jenis_penggunaan" class="form-control kode_jenis_penggunaan" required>
                                                                        ...
                                                                        <?php foreach ($data['ref_jenis_penggunaan'] as $i) : ?>
                                                                            <option value="<?= $i['kode_jenis_penggunaan'] ?>" <?= $i['kode_jenis_penggunaan'] == $data['data']['kode_jenis_penggunaan'] ? 'selected="selected"' : ''; ?>><?= $i['kode_jenis_penggunaan'] . ' - ' . $i['jenis_penggunaan'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select name="kode_sektor_ekonomi" class="form-control select2bs4 kode_sektor_ekonomi" required>
                                                                        ...
                                                                        <?php foreach ($data['ref_sektor_ekonomi'] as $i) : ?>
                                                                            <option value="<?= $i['kode_sektor_ekonomi'] ?>" <?= $i['kode_sektor_ekonomi'] == $data['data']['kode_sektor_ekonomi'] ? 'selected="selected"' : ''; ?>><?= $i['kode_sektor_ekonomi'] . ' - ' . $i['sektor_ekonomi'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </td>
                                                            </tr>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            ...
                                                            for ($a = 1; $a <= 10; $a++) {
                                                                if (isset($data['data']['jaminan_' . $a])) {
                                                            ?>
                                                                    <tr>
                                                                        <td style="width:180px;">Jaminan <?= $a ?></td>
                                                                        <td><input type="text" class="form-control" value='<?= $data['data']['jaminan_' . $a] ?>' name="jaminan_<?= $a ?>"></td>
                                                                    </tr>
                                                                <?php
                                                                } else {
                                                                ?>
                                                                    ...
                                                                    <tr>
                                                                        <td style="width:180px;">Jaminan <?= $a ?></td>
                                                                        <td><input type="text" class="form-control" value='' name="jaminan_<?= $a ?>"></td>
                                                                    </tr>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary btn-lg btn_update"> Update</button>
    ...
    <script>
        $('.myForm').on('submit', function(e) {
            ...
            kode_instansi = kode_instansi.val().split('##')
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            var temp_no_pk = update(res)
                            var temp_no_pk2 = temp_no_pk;

                            console.log(temp_no_pk)

                            var no_pk = temp_no_pk.split('/')

                            var no_pk_terakhir = no_pk[0];

                            var temp_inkaso = no_pk[1].split('-')

                            var inkaso = temp_inkaso[1]



                            console.log("no pk " + temp_no_pk2)

                            $.ajax({
                                type: 'POST',
                                url: "<?= BASEURL . '/pencairan/update_proses_pencairan/' ?>",
                                data: $('.myForm').serialize() + '&no_pk_terakhir=' + no_pk_terakhir + '&no_pk=' + temp_no_pk2 + '&inkaso=' + inkaso,
                                success: function(res) {
                                    if (res == 'berhasil') {
        ...
        function update(no_pk_terakhir) {

            var no_pk = '';
            var temp_no_pk = "";
            var jenis_no_pk = jenis_no_pk = $('.jenis_no_pk').val()

            var tgl_mulai_jw = $('.tgl_mulai_jw')
            var kode_instansi = $('.kode_instansi');
            kode_instansi = kode_instansi.val().split('##')
            temp_no_pk = "<?= $data['data']['no_pk'] ?>".split('/')
            ...
            $(document).on('change', '.kode_instansi, .jenis_no_pk', function() {
                jenis_no_pk = $('.jenis_no_pk').val()
            })


            if (kode_instansi[0] == '<?= $data['data']['inkaso'] ?>') {

                no_pk = temp_no_pk[0] + '/' + jenis_no_pk + '-' + kode_instansi[0] + '/' + '<?= $_COOKIE['kode_cabang'] ?>' + '/' + tgl_mulai_jw_fix;
            } else {

                no_pk = no_pk_terakhir + '/' + jenis_no_pk + '-' + kode_instansi[0] + '/' + '<?= $_COOKIE['kode_cabang'] ?>' + '/' + tgl_mulai_jw_fix;
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.tgl_lahir_debitur').mask('00/00/0000');
            const d = new Date('<?= $data['data']['tgl_lahir_debitur'] ?>');
            $('.tgl_lahir_debitur').val(moment(d).format("DD/MM/YYYY"))
            ...
            const dd = new Date('<?= $data['data']['tgl_surat_kuasa_pasangan'] ?>');


            if (dd != 'Invalid Date') {
                $('.tgl_surat_kuasa_pasangan').val(moment(dd).format("DD/MM/YYYY"))
            }



            $('.tgl_mulai_jw').mask('00/00/0000');
            const f = new Date('<?= $data['data']['tgl_mulai_jw'] ?>');

            console.log(f)

            if (f != 'Invalid Date') {
                $('.tgl_mulai_jw').val(moment(f).format("DD/MM/YYYY"))
            }



            $('.tgl_akhir_jw').mask('00/00/0000');
            const g = new Date('<?= $data['data']['tgl_akhir_jw'] ?>');


            if (g != 'Invalid Date') {
                $('.tgl_akhir_jw').val(moment(g).format("DD/MM/YYYY"))
            }


            $('.tgl_mulai_angsuran').mask('00/00/0000');
            const h = new Date('<?= $data['data']['tgl_mulai_angsuran'] ?>');
            $('.tgl_mulai_angsuran').val(moment(h).format("DD/MM/YYYY"))

            $('.tgl_akhir_angsuran').mask('00/00/0000');
            const i = new Date('<?= $data['data']['tgl_akhir_angsuran'] ?>');
            $('.tgl_akhir_angsuran').val(moment(i).format("DD/MM/YYYY"))
