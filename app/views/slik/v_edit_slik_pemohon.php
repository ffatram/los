...
<head>
    ...
    <title>Edit Data SLIK Pemohon</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Data SLIK Pemohon</h1>
                        </div>
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <main class="content">
                                                        ...
                                                        <div class="">
                                                            <div class="">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="nama_bank" class="form-control select2bs4">
                                                                        <option value="" disabled selected>- Silahkan Pilih -</option>
                                                                        <?php foreach ($data['nama_bank'] as $i) : ?>
                                                                            <option value="<?= $i['nama_bank'] ?>" <?= $i['nama_bank'] == $data['edit_data_pemohon_where_id']['nama_bank'] ? 'selected="selected"' : ''; ?>><?php echo $i['nama_bank'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                    ...
                                                                    <select name="jenis_fasilitas" class="form-control" required>
                                                                        ...
                                                                        <?php foreach ($data['nama_fasilitas'] as $i) : ?>
                                                                            <option value="<?= $i['nama_fasilitas'] ?>" <?= $i['nama_fasilitas'] == $data['edit_data_pemohon_where_id']['jenis_fasilitas'] ? 'selected="selected"' : ''; ?>><?php echo $i['nama_fasilitas'] ?></option>
                                                                        <?php endforeach; ?>

                                                                        <!-- <option value="LAINNYA" <?= "LAINNYA" == $data['edit_data_pemohon_where_id']['jenis_fasilitas'] ? 'selected="selected"' : ''; ?>><?= "LAINNYA" ?></option> -->

                                                                    </select>
                                                                    <label class="mt-2 mb-2">Plafond (Rp)</label><span class="ml-1" style="color:red;">*</span>
                                                                    <input type="text" id="1" class="form-control plafond" name="plafond" value="<?= $data['edit_data_pemohon_where_id']['plafond'] ?>" onkeypress="return hanyaAngka(event)" required />
                                                                    <label class="mt-2 mb-2">Bakidebet (Rp)</label><span class="ml-1" style="color:red;">*</span>
                                                                    <input type="text" id="1" class="form-control bakidebet" name="bakidebet" value="<?= $data['edit_data_pemohon_where_id']['bakidebet'] ?>" onkeypress="return hanyaAngka(event)" required />
                                                                    <label class="mt-2 mb-2">Kolektibilitas</label><span class="ml-1" style="color:red;">*</span>
                                                                    <select name="kolektibilitas" class="form-control">
                                                                        <option value="" disabled selected>- Silahkan Pilih -</option>
                                                                        <option value="1" <?= "1" == $data['edit_data_pemohon_where_id']['kolektibilitas'] ? 'selected="selected"' : ''; ?>><?= "1" ?></option>
                                                                        <option value="2" <?= "2" == $data['edit_data_pemohon_where_id']['kolektibilitas'] ? 'selected="selected"' : ''; ?>><?= "2" ?></option>
                                                                        <option value="3" <?= "3" == $data['edit_data_pemohon_where_id']['kolektibilitas'] ? 'selected="selected"' : ''; ?>><?= "3" ?></option>
                                                                        <option value="4" <?= "4" == $data['edit_data_pemohon_where_id']['kolektibilitas'] ? 'selected="selected"' : ''; ?>><?= "4" ?></option>
                                                                        <option value="5" <?= "5" == $data['edit_data_pemohon_where_id']['kolektibilitas'] ? 'selected="selected"' : ''; ?>><?= "5" ?></option>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col ">
                                                                            ...
                                                                            $a  = $data['edit_data_pemohon_where_id']['waktu_awal'];
                                                                            $b = explode("-", $a);


                                                                            $data['edit_data_pemohon_where_id']['waktu_awal'] = $b[2] . '-' . $b[1]  . '-' . $b[0];


                                                                            ?>

                                                                            <input type="text" name="waktu_awal" class="form-control date" placeholder="dd/mm/yyyy" value="<?= $data['edit_data_pemohon_where_id']['waktu_awal'] ?>" required>
                                                                        ...
                                                                        <div class="col">
                                                                            ...
                                                                            $a  = $data['edit_data_pemohon_where_id']['waktu_akhir'];
                                                                            $b = explode("-", $a);

                                                                            $data['edit_data_pemohon_where_id']['waktu_akhir'] = $b[2] . '-' . $b[1]  . '-' . $b[0];


                                                                            ?>

                                                                            <input type="text" name="waktu_akhir" class="form-control date" placeholder="dd/mm/yyyy" value="<?= $data['edit_data_pemohon_where_id']['waktu_akhir'] ?>" required>

                                                                        </div>

                                                                    </div>
                                                                    <label class="mt-2 mb-2">Suka Bunga % </label>
                                                                    <input type="text" class="form-control" name="suku_bunga" value="<?= $data['edit_data_pemohon_where_id']['suku_bunga'] ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="jenis_jaminan" class="form-control">
                                                                        ...
                                                                        <?php foreach ($data['nama_jaminan'] as $i) : ?>
                                                                            <option value="<?= $i['nama_jaminan'] ?>" <?= $i['nama_jaminan'] == $data['edit_data_pemohon_where_id']['jenis_jaminan'] ? 'selected="selected"' : ''; ?>><?php echo $i['nama_jaminan'] ?></option>
                                                                        <?php endforeach; ?>
                                                                        <!-- <option value="LAINNYA" <?= "LAINNYA" == $data['edit_data_pemohon_where_id']['jenis_jaminan'] ? 'selected="selected"' : ''; ?>><?= "LAINNYA" ?></option> -->

                                                                    </select>
                                                                    <label class="mt-2 mb-2">Nilai Perkiraan Jaminan (Rp) </label>
                                                                    <input type="text" id="2" class="form-control nilai_jaminan" name="nilai_jaminan" value="<?= $data['edit_data_pemohon_where_id']['nilai_jaminan'] ?>" onkeypress="return hanyaAngka(event)" />
                                                                    <label class="mt-2 mb-2">Pemilik Jaminan </label>
                                                                    <input type="text" id="2" class="form-control" name="pemilik_jaminan" value="<?= $data['edit_data_pemohon_where_id']['pemilik_jaminan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                                    <label class="mt-2 mb-2">Alamat Jaminan</label>
                                                                    <input type="text" id="2" class="form-control" name="alamat_jaminan" oninput="this.value = this.value.toUpperCase()" value="<?= $data['edit_data_pemohon_where_id']['alamat_jaminan'] ?>" />
                                                                    <label class="mt-2 mb-2">Pengikatan </label>
                                                                    <select name="pengikatan" class="form-control">
                                                                        <option value="" disabled selected>- Silahkan Pilih -</option>
                                                                        <?php foreach ($data['nama_pengikatan'] as $i) : ?>
                                                                            <option value="<?= $i['nama_pengikatan'] ?>" <?= $i['nama_pengikatan'] == $data['edit_data_pemohon_where_id']['pengikatan'] ? 'selected="selected"' : ''; ?>><?php echo $i['nama_pengikatan'] ?></option>
                                                                        <?php endforeach; ?>

                                                                        <!-- <option value="LAINNYA" <?= "LAINNYA" == $data['edit_data_pemohon_where_id']['pengikatan'] ? 'selected="selected"' : ''; ?>><?= "LAINNYA" ?></option> -->

                                                                        <!-- <option value="A" <?= "A" == $data['edit_data_pemohon_where_id']['pengikatan'] ? 'selected="selected"' : ''; ?>><?= "A" ?></option>
                                                <option value="B" <?= "B" == $data['edit_data_pemohon_where_id']['pengikatan'] ? 'selected="selected"' : ''; ?>><?= "B" ?></option>
                                                <option value="C" <?= "C" == $data['edit_data_pemohon_where_id']['pengikatan'] ? 'selected="selected"' : ''; ?>><?= "C" ?></option>
                                                <option value="LAINNYA" <?= "LAINNYA" == $data['edit_data_pemohon_where_id']['pengikatan'] ? 'selected="selected"' : ''; ?>><?= "LAINNYA" ?></option> -->

                                                                    </select>
                                                                    <label class="mt-2 mb-2">Keterangan</label>

                                                                    <textarea name="keterangan" class="form-control h-25" rows="4" placeholder="" oninput="this.value = this.value.toUpperCase()"><?= $data['edit_data_pemohon_where_id']['keterangan'] ?></textarea>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Pemohon <span class="text-success"><?= $data['get_jumlah_data_slik_pemohon'] ?> Fasilitas</span></a>
                        </li>
