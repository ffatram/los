        ...
        <div class="content-wrapper">
            ...
            <input class="testInput" type="text" value="8" /> -->
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <label class="mt-2 mb-2">Nama</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="nama_pemohon" value="<?= $data['data_kredit']['nama_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tempat Lahir</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="tempat_lahir_pemohon" value="<?= $data['data_kredit']['tempat_lahir_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class=" mt-2 mb-2">Tanggal Lahir</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="date" class="form-control" name="tgl_lahir_pemohon" value="<?= $data['data_kredit']['tgl_lahir_pemohon'] ?>" required />
                                                    ...
                                                    <input type="text" class="form-control" name="nama_ibu_kandung_pemohon" value="<?= $data['data_kredit']['nama_ibu_kandung_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">No. KTP</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="no_ktp_pemohon" value="<?= $data['data_kredit']['no_ktp_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">NPWP</label>
                                                    <input type="text" class="form-control" name="npwp_pemohon" value="<?= $data['data_kredit']['npwp_pemohon'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat (Sesuai KTP)</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="alamat_ktp_pemohon" value="<?= $data['data_kredit']['alamat_ktp_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat Sekarang</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="alamat_sekarang_pemohon" value="<?= $data['data_kredit']['alamat_sekarang_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="telepon_pemohon" value="<?= $data['data_kredit']['telepon_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    ...
                                                    <select name="status_kepemilikan_rumah_pemohon" class="form-control" required>
                                                        <option value="" disabled selected>- Silahkan Pilih -</option>
                                                    ...
                                                    <select name="pendidikan_terakhir_pemohon" class="form-control" required>
                                                        <option value="" disabled selected>- Silahkan Pilih -</option>
                                                    ...
                                                    <input type="text" class="form-control" name="nama_keluarga_dapat_dihubungi" value="<?= $data['data_kredit']['nama_keluarga_dapat_dihubungi'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat</label>
                                                    <input type="text" class="form-control" name="alamat_keluarga_dapat_dihubungi" value="<?= $data['data_kredit']['alamat_keluarga_dapat_dihubungi'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Hubungan</label>
                                                    <input type="text" class="form-control" name="hubungan_keluarga_dapat_dihubungi" value="<?= $data['data_kredit']['hubungan_keluarga_dapat_dihubungi'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon/Hp Yang Dapat Dihubungi</label>
                                                    <input type="text" class="form-control" name="telepon_keluarga_dapat_dihubungi" value="<?= $data['data_kredit']['telepon_keluarga_dapat_dihubungi'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_instansi" value="<?= $data['data_kredit']['nama_instansi'] ?>" required oninput="this.value = this.value.toUpperCase()" />

                                                    <label class="mt-2 mb-2">Alamat</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="alamat_instansi" value="<?= $data['data_kredit']['alamat_instansi'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon</label>
                                                    <input type="text" class="form-control" name="telepon_instansi" value="<?= $data['data_kredit']['telepon_instansi'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tahun Mulai Bekerja</label>
                                                    <input type="text" class="form-control" name="tahun_mulai_bekerja" value="<?= $data['data_kredit']['tahun_mulai_bekerja'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Jabatan Saat Ini</label>
                                                    <input type="text" class="form-control" name="jabatan_saat_ini" value="<?= $data['data_kredit']['jabatan_saat_ini'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Atasan Langsung</label>
                                                    <input type="text" class="form-control" name="atasan_langsung" value="<?= $data['data_kredit']['atasan_langsung'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telp/Hp Bendahara</label>
                                                    <input type="text" class="form-control" name="telepon_bendahara" value="<?= $data['data_kredit']['telepon_bendahara'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                    <br>
                                    ...
                                    <div class="col-12 col-lg-6 col-xxl-6 ">
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="mt-2 mb-2">Nama </label>
                                                    <input type="text" class="form-control a1" name="nama_pasangan" value="<?= $data['data_kredit']['nama_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tempat Lahir </label>
                                                    <input type="text" class="form-control a2" name="tempat_lahir_pasangan" value="<?= $data['data_kredit']['tempat_lahir_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tanggal Lahir</label>
                                                    <input type="date" class="form-control a3" name="tgl_lahir_pasangan" value="<?= $data['data_kredit']['tgl_lahir_pasangan'] ?>" />
                                                    <label class="mt-2 mb-2">No KTP </label>
                                                    <input type="text" class="form-control a4" name="no_ktp_pasangan" value="<?= $data['data_kredit']['no_ktp_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat KTP</label>
                                                    <input type="text" class="form-control a5" name="alamat_ktp_pasangan" value="<?= $data['data_kredit']['alamat_ktp_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat Sekarang</label>
                                                    <input type="text" class="form-control a6" name="alamat_sekarang_pasangan" value="<?= $data['data_kredit']['alamat_sekarang_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon / Hp</label>
                                                    <input type="text" class="form-control a7" name="telepon_pasangan" value="<?= $data['data_kredit']['telepon_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control a9" name="nama_instansi_pasangan" value="<?= $data['data_kredit']['nama_instansi_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tahun Mulai Bekerja</label>
                                                    <input type="text" class="form-control a10" name="tahun_mulai_bekerja_pasangan" value="<?= $data['data_kredit']['tahun_mulai_bekerja_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Jabatan Saat Ini</label>
                                                    <input type="text" class="form-control a11" name="jabatan_saat_ini_pasangan" value="<?= $data['data_kredit']['jabatan_saat_ini_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat Kantor</label>
                                                    <input type="text" class="form-control a12" name="alamat_kantor_pasangan" value="<?= $data['data_kredit']['alamat_kantor_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon Kantor</label>
                                                    <input type="text" class="form-control a13" name="telepon_kantor_pasangan" value="<?= $data['data_kredit']['telepon_kantor_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="date" id="" class="form-control" name="tanggal_permohonan" value="<?= $data['data_kredit']['tanggal_permohonan'] ?>" required />
                                                ...
                                                <input type="text" id="1" class="form-control plafond" name="plafond_dimohon" value="<?= $data['data_kredit']['plafond_dimohon'] ?>" onkeypress="return hanyaAngka(event)" required />
                                                <label class="mt-2 mb-2">Jangka Waktu (Bulan) </label><span class="ml-1" style="color:red;">*</span>
                                                <input type="number" onkeypress="return isNumberKey(event)" class="form-control" name="jangka_waktu" value="<?= $data['data_kredit']['jangka_waktu'] ?>" required />

                                                <label class="mt-2 mb-2">Tujuan Penggunaan Kredit </label><span class="ml-1" style="color:red;">*</span>
                                                <select name="tujuan_penggunaan_kredit" class="form-control" required>
                                                    <option value="" disabled selected>- Silahkan Pilih -</option>
                                                    <?php foreach ($data['get_all_tujuan_penggunaan_kredit'] as $i) : ?>
                                                        <option value="<?= $i['kode'] ?>" <?= $i['kode'] == $data['data_kredit']['tujuan_penggunaan_kredit'] ? 'selected="selected"' : ''; ?>><?= $i['kode'] . ' - ' . $i['keterangan'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                ...
                                                <select name="jenis_jaminan" class="form-control">
                                                    <option value="" disabled selected>- Silahkan Pilih -</option>
                                                    <option value="TANAH & BANGUNAN" <?= "TANAH & BANGUNAN" == $data['data_kredit']['jenis_jaminan'] ? 'selected="selected"' : ''; ?>><?= "TANAH & BANGUNAN" ?></option>
                                                    <option value="KENDARAAN BERMOTOR" <?= "KENDARAAN BERMOTOR" == $data['data_kredit']['jenis_jaminan'] ? 'selected="selected"' : ''; ?>><?= "KENDARAAN BERMOTOR" ?></option>
                                                    <option value="SIMPANAN" <?= "SIMPANAN" == $data['data_kredit']['jenis_jaminan'] ? 'selected="selected"' : ''; ?>><?= "SIMPANAN" ?></option>
                                                    <option value="LAINNYA" <?= "LAINNYA" == $data['data_kredit']['jenis_jaminan'] ? 'selected="selected"' : ''; ?>><?= "LAINNYA" ?></option>


                                                </select>

                                                <label class="mt-2 mb-2">Nilai Perkiraan Jaminan (Rp) </label>
                                                <input type="text" id="2" class="form-control nilai_jaminan" name="nilai_jaminan" value="<?= $data['data_kredit']['nilai_jaminan'] ?>" onkeypress="return hanyaAngka(event)" />
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control penghasilan_pemohon" id="3" name="penghasilan_pemohon" value="<?= $data['data_kredit']['penghasilan_pemohon'] ?>" onkeypress="return hanyaAngka(event)" required />
                                                    <label class="mt-2 mb-2">Penghasilan Pasangan (Rp)</label>
                                                    <input type="text" class="form-control penghasilan_pasangan a14" id="4" class="form-control" name="penghasilan_pasangan" value="<?= $data['data_kredit']['penghasilan_pasangan'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Penghasilan Tambahan (Rp)</label>
                                                    <input type="text" class="form-control penghasilan_tambahan" id="5" class="form-control" name="penghasilan_tambahan" value="<?= $data['data_kredit']['penghasilan_tambahan'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Penghasilan Tambahan Lainnya (Rp)</label>
                                                    <input type="text" class="form-control penghasilan_tambahan_lainnya" id="6" class="form-control" name="penghasilan_tambahan_lainnya" value="<?= $data['data_kredit']['penghasilan_tambahan_lainnya'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                    <br>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control biaya_hidup_perbulan" id="7" name="biaya_hidup_perbulan" value="<?= $data['data_kredit']['biaya_hidup_perbulan'] ?>" onkeypress="return hanyaAngka(event)" required />
                                                    <label class="mt-2 mb-2">Biaya Pendidikan (Rp)</label>
                                                    <input type="text" class="form-control biaya_pendidikan" id="8" name="biaya_pendidikan" value="<?= $data['data_kredit']['biaya_pendidikan'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Biaya PAM/Listrik/Tlp/Hp (Rp)</label>
                                                    <input type="text" class="form-control biaya_pam_listrik_telepon" id="9" name="biaya_pam_listrik_telepon" value="<?= $data['data_kredit']['biaya_pam_listrik_telepon'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Biaya Transport (Rp)</label>
                                                    <input type="text" class="form-control biaya_transport" id="9" name="biaya_transport" value="<?= $data['data_kredit']['biaya_transport'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Bank Lain (Rp)</label>
                                                    <input type="text" class="form-control angsuran_bank_lain" id="10" name="angsuran_bank_lain" value="<?= $data['data_kredit']['angsuran_bank_lain'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Perumahan (Rp)</label>
                                                    <input type="text" class="form-control angsuran_perumahan" id="11" name="angsuran_perumahan" value="<?= $data['data_kredit']['angsuran_perumahan'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Kendaraan (Rp)</label>
                                                    <input type="text" class="form-control angsuran_kendaraan" id="12" name="angsuran_kendaraan" value="<?= $data['data_kredit']['angsuran_kendaraan'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Barang Elektronik (Rp)</label>
                                                    <input type="text" class="form-control angsuran_barang_elektronik" id="13" name="angsuran_barang_elektronik" value="<?= $data['data_kredit']['angsuran_barang_elektronik'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Koperasi (Rp)</label>
                                                    <input type="text" class="form-control angsuran_koperasi" id="14" name="angsuran_koperasi" value="<?= $data['data_kredit']['angsuran_koperasi'] ?>" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Biaya Lainnya (Rp)</label>
                                                    <input type="text" class="form-control biaya_lainnya" id="15" name="biaya_lainnya" value="<?= $data['data_kredit']['biaya_lainnya'] ?>" onkeypress="return hanyaAngka(event)" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="text" class="form-control" name="alamat_aset" value="<?= $data['data_kredit']['alamat_aset'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                ...
                                                <input type="text" class="form-control" name="jumlah_kendaraan" value="<?= $data['data_kredit']['jumlah_kendaraan'] ?>" />
                                                <label class="mt-2 mb-2">Merk Kendaraan</label>
                                                <input type="text" class="form-control" name="merek_kendaraan" value="<?= $data['data_kredit']['merek_kendaraan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                <label class="mt-2 mb-2">Tahun Kendaraan</label>
                                                <input type="text" class="form-control" name="tahun_kendaraan" value="<?= $data['data_kredit']['tahun_kendaraan'] ?>" />
                                                <label class="mt-2 mb-2">Atas Nama Kendaraan</label>
                                                <input type="text" class="form-control" name="atas_nama_kendaraan" value="<?= $data['data_kredit']['atas_nama_kendaraan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-check form-check-inline">
                                <input name="lokasi_berkas" class="form-check-input" type="radio" id="cs" value="CS" <?= "CS" == $data['data_kredit']['lokasi_berkas'] ? 'checked="checked"' : ''; ?>>
                                <label class="form-check-label" for="cs">CS</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="lokasi_berkas" id="slik" value="SLIK" <?= "SLIK" == $data['data_kredit']['lokasi_berkas'] ? 'checked="checked"' : ''; ?>>
                                <label class="form-check-label" for="slik">SLIK</label>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" name="batal_permohonan" id="batal_permohonan" value="batal_permohonan" <?= $data['data_kredit']['tanggal_batal'] != "" ? 'checked="checked"' : ''; ?>>
                                                    <label class="form-check-label" for="batal_permohonan">Batal Permohonan</label>
                                                </div>
