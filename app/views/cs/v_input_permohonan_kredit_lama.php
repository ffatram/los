        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id="form_cs_edit_data_kredit" id="form_update" action="<?= BASEURL; ?>/cs/simpan_data" method="POST">
                        <main class="content">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="text" class="form-control date2" name="tanggal_permohonan" readonly required />
