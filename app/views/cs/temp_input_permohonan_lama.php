...
<head>
    ...
    <title>Input Permohonan Kredit Lama</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Input Permohonan Kredit Lama</h1>
                        </div>
            ...
            <section class="content ">
                ...
                <div class="container-fluid">
                    ...
                    <form id="form_cs_edit_data_kredit_lama" id="form_update" action="<?= BASEURL; ?>/cs/simpan_input_permohonan_kredit_lama" method="POST">
                        <main class="content">
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <input type="hidden" class="form-control" name="id" value="<?= $data['data_kredit']['id'] ?>" />
                                                    <label class="mt-2 mb-2">Nama</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_pemohon" value="<?= $data['data_kredit']['nama_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    ...
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_ibu_kandung_pemohon" value="<?= $data['data_kredit']['nama_ibu_kandung_pemohon'] ?>" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">No. KTP</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="no_ktp_pemohon" value="<?= $data['data_kredit']['no_ktp_pemohon'] ?>" maxlength="16" required />
                                                    <label class="mt-2 mb-2">NPWP</label>
                                                    <input type="text" class="form-control" name="npwp_pemohon" onkeypress="return hanyaAngka(event)" value="<?= $data['data_kredit']['npwp_pemohon'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    ...
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_keluarga_dapat_dihubungi" value="<?= $data['data_kredit']['nama_keluarga_dapat_dihubungi'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="tahun_mulai_bekerja" onkeypress="return hanyaAngka(event)" value="<?= $data['data_kredit']['tahun_mulai_bekerja'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                    ...
                                    <div class="col-12 col-lg-6 col-xxl-6 ">
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="mt-2 mb-2">Nama </label>
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_pasangan" value="<?= $data['data_kredit']['nama_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tempat Lahir </label>
                                                    <input type="text" class="form-control" name="tempat_lahir_pasangan" value="<?= $data['data_kredit']['tempat_lahir_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tanggal Lahir</label>
                                                    <input type="date" class="form-control" name="tgl_lahir_pasangan" value="<?= $data['data_kredit']['tgl_lahir_pasangan'] ?>" />
                                                    <label class="mt-2 mb-2">No KTP </label>
                                                    <input type="text" class="form-control" name="no_ktp_pasangan" value="<?= $data['data_kredit']['no_ktp_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat KTP</label>
                                                    <input type="text" class="form-control" name="alamat_ktp_pasangan" value="<?= $data['data_kredit']['alamat_ktp_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat Sekarang</label>
                                                    <input type="text" class="form-control" name="alamat_sekarang_pasangan" value="<?= $data['data_kredit']['alamat_sekarang_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon / Hp</label>
                                                    <input type="text" class="form-control" name="telepon_pasangan" value="<?= $data['data_kredit']['telepon_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_instansi_pasangan" value="<?= $data['data_kredit']['nama_instansi_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tahun Mulai Bekerja</label>
                                                    <input type="text" class="form-control" name="tahun_mulai_bekerja_pasangan" value="<?= $data['data_kredit']['tahun_mulai_bekerja_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Jabatan Saat Ini</label>
                                                    <input type="text" class="form-control" name="jabatan_saat_ini_pasangan" value="<?= $data['data_kredit']['jabatan_saat_ini_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat Kantor</label>
                                                    <input type="text" class="form-control" name="alamat_kantor_pasangan" value="<?= $data['data_kredit']['alamat_kantor_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon Kantor</label>
                                                    <input type="text" class="form-control" name="telepon_kantor_pasangan" value="<?= $data['data_kredit']['telepon_kantor_pasangan'] ?>" oninput="this.value = this.value.toUpperCase()" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="date" id="" class="form-control" name="tanggal_permohonan" value="<?php echo date('Y-m-d'); ?>" required />
                                                ...
                                                <input type="text" id="1" class="form-control plafond" name="plafond_dimohon" onkeypress="return hanyaAngka(event)" required />
                                                <label class="mt-2 mb-2">Jangka Waktu (Bulan) </label><span class="ml-1" style="color:red;">*</span>
                                                <input type="text" class="form-control" onkeypress="return hanyaAngka(event)" maxlength="3" name="jangka_waktu" required />
                                                ...
                                                <input type="text" id="2" class="form-control nilai_jaminan" name="nilai_jaminan" onkeypress="return hanyaAngka(event)" />
                                                ...
                                                <select name="id_marketing" class="form-control" required>
                                                    ...
                                                    <?php foreach ($data['nama_marketing'] as $i) : ?>
                                                        <option value="<?= $i['nama_marketing'] ?>"><?= $i['nama_marketing'] ?></option>
                                                    <?php endforeach; ?>
                                                ...
                                                <select name="id_analis" class="form-control" required>
                                                    ...
                                                    <?php foreach ($data['nama_ro'] as $i) : ?>
                                                        <option value="<?= $i['nama_ro'] ?>"><?= $i['nama_ro'] ?></option>
                                                    <?php endforeach; ?>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control penghasilan_pemohon" id="3" name="penghasilan_pemohon" onkeypress="return hanyaAngka(event)" required />
                                                    <label class="mt-2 mb-2">Penghasilan Pasangan (Rp)</label>
                                                    <input type="text" class="form-control penghasilan_pasangan" id="4" name="penghasilan_pasangan" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Penghasilan Tambahan (Rp)</label>
                                                    <input type="text" class="form-control penghasilan_tambahan" id="5" name="penghasilan_tambahan" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Penghasilan Tambahan Lainnya (Rp)</label>
                                                    <input type="text" class="form-control penghasilan_tambahan_lainnya" id="6" name="penghasilan_tambahan_lainnya" onkeypress="return hanyaAngka(event)" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                    <br>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control biaya_hidup_perbulan" id="7" name="biaya_hidup_perbulan" onkeypress="return hanyaAngka(event)" required />
                                                    <label class="mt-2 mb-2">Biaya Pendidikan (Rp)</label>
                                                    <input type="text" class="form-control biaya_pendidikan" id="8" name="biaya_pendidikan" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Biaya PAM/Listrik/Tlp/Hp (Rp)</label>
                                                    <input type="text" class="form-control biaya_pam_listrik_telepon" id="9" name="biaya_pam_listrik_telepon" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Biaya Transport (Rp)</label>
                                                    <input type="text" class="form-control biaya_transport" id="9" name="biaya_transport" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Bank Lain (Rp)</label>
                                                    <input type="text" class="form-control angsuran_bank_lain" id="10" name="angsuran_bank_lain" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Perumahan (Rp)</label>
                                                    <input type="text" class="form-control angsuran_perumahan" id="11" name="angsuran_perumahan" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Kendaraan (Rp)</label>
                                                    <input type="text" class="form-control angsuran_kendaraan" id="12" name="angsuran_kendaraan" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Barang Elektronik (Rp)</label>
                                                    <input type="text" class="form-control angsuran_barang_elektronik" id="13" name="angsuran_barang_elektronik" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Angsuran Koperasi (Rp)</label>
                                                    <input type="text" class="form-control angsuran_koperasi" id="14" name="angsuran_koperasi" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Biaya Lainnya (Rp)</label>
                                                    <input type="text" class="form-control biaya_lainnya" id="15" name="biaya_lainnya" onkeypress="return hanyaAngka(event)" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="text" class="form-control" name="alamat_aset" oninput="this.value = this.value.toUpperCase()" />
                                                ...
                                                <input type="text" class="form-control" name="merek_kendaraan" oninput="this.value = this.value.toUpperCase()" />
                                                ...
                                                <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="atas_nama_kendaraan" oninput="this.value = this.value.toUpperCase()" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <textarea name="catatan_cs" class="form-control h-25" rows="5" oninput="this.value = this.value.toUpperCase()"></textarea>
                            ...
                            <button id="btn_form_cs_edit_data_kredit" type="submit" class="btn btn-primary btn-lg">Simpan</button>
                            <a onclick="btn_batal_input_kredit_lama(event); return false" href="<?= BASEURL; ?>/cs/daftar_permohonan_kredit" class="btn btn-secondary btn-lg ">Batal</a>
