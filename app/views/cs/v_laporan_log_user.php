        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" class="form-control tanggal_mulai" value="<?= date('Y-m-d') ?>" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Tanggal Akhir</label>
                                    <input type="date" class="form-control tanggal_akhir" value="<?= date('Y-m-d') ?>" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Nama User</label>
                                    <div class="input-group input-group-xl ">
                                        <select class="form-control nama_user" name="nama_user" required>
                                            <option>ELKANA</option>
                                            <option>CS_GOWA</option>
                                            <option>CS_UTAMA</option>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group col-md-12 float-right">
                                    <button type="button" class="btn btn-primary btn-block btn-flat btn_cari">Cari</button>
                                </div>
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- data table akan di tampilkan di sini -->
                    <div id="data_log_user">
