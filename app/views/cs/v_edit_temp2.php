                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_ibu_kandung_pemohon" oninput="this.value = this.value.toUpperCase()" value="<?= $data['data_kredit']['nama_ibu_kandung_pemohon'] ?>" required />
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control nama_instansi" name="nama_instansi" required oninput="this.value = this.value.toUpperCase()" value="<?= $data['data_kredit']['nama_instansi'] ?>" readonly required />
                                ...
                                <div class="row ">
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control penghasilan_pemohon" id="3" name="penghasilan_pemohon" onkeypress="return hanyaAngka(event)" value="<?= $data['data_kredit']['penghasilan_pemohon'] ?>" />
                                    ...
                                    <div class="col-12 col-lg-6 col-xxl-6 ">
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="mt-2 mb-2">Biaya Hidup Perbulan (Rp)</label>
                                                    <input type="text" class="form-control biaya_hidup_perbulan" id="7" name="biaya_hidup_perbulan" onkeypress="return hanyaAngka(event)" value="<?= $data['data_kredit']['biaya_hidup_perbulan'] ?>" />
