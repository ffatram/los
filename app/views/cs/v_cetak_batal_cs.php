...
<body>
    ...
    <div style="font-size: 10px; text-align: center;"><b>LAPORAN PERMOHONAN KREDIT (BATAL)</b></div>
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><?= $row['tanggal_batal'] != "" ? date("d-m-Y", strtotime($row['tanggal_batal'])) : '';  ?></td>
