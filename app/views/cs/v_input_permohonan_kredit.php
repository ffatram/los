...
<head>
    ...
    <title>Input Permohonan Kredit</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h2 class="m-0"><b>Input Permohonan Kredit</b></h2>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <form id="form_cs_simpan_data_kredit" action="<?= BASEURL; ?>/cs/simpan_data" method="POST">
                        <main class="content">
                            <div class="container-fluid p-0">
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_pemohon" oninput="this.value = this.value.toUpperCase()" required />
                                                    <label class="mt-2 mb-2">Tempat Lahir</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="tempat_lahir_pemohon" required oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tanggal Lahir</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control date" name="tgl_lahir_pemohon" placeholder="dd/mm/yyyy" required />
                                                    ...
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_ibu_kandung_pemohon" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">No. KTP</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="no_ktp_pemohon" onkeypress="return hanyaAngka(event)" maxlength="16" required />
                                                    <label class="mt-2 mb-2">NPWP</label>
                                                    <input type="text" class="form-control" name="npwp_pemohon" onkeypress="return hanyaAngka(event)" />
                                                    <label class="mt-2 mb-2">Alamat (Sesuai KTP)</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="alamat_ktp_pemohon" oninput="this.value = this.value.toUpperCase()" required />
                                                    <label class="mt-2 mb-2">Alamat Sekarang</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="alamat_sekarang_pemohon" oninput="this.value = this.value.toUpperCase()" required />
                                                    <label class="mt-2 mb-2">Telepon</label><span class="ml-1" style="color:red;">*</span>
                                                    <input type="text" class="form-control" name="telepon_pemohon" oninput="this.value = this.value.toUpperCase()" required />
                                                    ...
                                                    <input type="text" class="form-control" onkeypress="return hanyaHuruf(event)" name="nama_keluarga_dapat_dihubungi" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat</label>
                                                    <input type="text" class="form-control" name="alamat_keluarga_dapat_dihubungi" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Hubungan</label>
                                                    <input type="text" class="form-control" name="hubungan_keluarga_dapat_dihubungi" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon/Hp Yang Dapat Dihubungi</label>
                                                    <input type="text" class="form-control" name="telepon_keluarga_dapat_dihubungi" oninput="this.value = this.value.toUpperCase()" />
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control nama_instansi" name="nama_instansi" required oninput="this.value = this.value.toUpperCase()" required />

                                                    <label class="mt-2 mb-2">Alamat Instansi</label>
                                                    <input type="text" class="form-control" name="alamat_instansi" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon Kantor</label>
                                                    <input type="text" class="form-control" name="telepon_instansi" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tahun Mulai Bekerja</label>
                                                    <input type="text" class="form-control" name="tahun_mulai_bekerja" onkeypress="return hanyaAngka(event)" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Jabatan Saat Ini</label>
                                                    <input type="text" class="form-control" name="jabatan_saat_ini" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Atasan Langsung</label>
                                                    <input type="text" class="form-control" name="atasan_langsung" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telp/Hp Bendahara</label>
                                                    <input type="text" class="form-control" name="telepon_bendahara" oninput="this.value = this.value.toUpperCase()" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                    <br>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control a1" onkeypress="return hanyaHuruf(event)" name="nama_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tempat Lahir Pasangan </label>
                                                    <input type="text" class="form-control a2 " name="tempat_lahir_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tanggal Lahir Pasangan</label>
                                                    <input type="text" class="form-control a3 date" name="tgl_lahir_pasangan" placeholder="dd/mm/yyyy" />
                                                    <label class="mt-2 mb-2">No. KTP Pasangan </label>
                                                    <input type="text" class="form-control a4 " name="no_ktp_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat KTP Pasangan</label>
                                                    <input type="text" class="form-control a5 " name="alamat_ktp_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat Sekarang Pasangan</label>
                                                    <input type="text" class="form-control a6 " name="alamat_sekarang_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon / Hp Pasangan</label>
                                                    <input type="text" class="form-control a7 " name="telepon_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control a9 " name="nama_instansi_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Tahun Mulai Bekerja Pasangan</label>
                                                    <input type="text" class="form-control a10 " name="tahun_mulai_bekerja_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Jabatan Saat Ini Pasangan</label>
                                                    <input type="text" class="form-control a11 " name="jabatan_saat_ini_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Alamat Kantor Pasangan</label>
                                                    <input type="text" class="form-control a12 " name="alamat_kantor_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <label class="mt-2 mb-2">Telepon Kantor Pasangan</label>
                                                    <input type="text" class="form-control a13 " name="telepon_kantor_pasangan" oninput="this.value = this.value.toUpperCase()" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="text" class="form-control date2" name="tanggal_permohonan" required readonly />
                                                ...
                                                <input type="text" class="form-control" onkeypress="return hanyaAngka(event)" maxlength="3" name="jangka_waktu" onwheel="return false;" required />
                                                <label class="mt-2 mb-2">Tujuan Penggunaan Kredit </label><span class="ml-1" style="color:red;">*</span>
                                                <input type="text" class="form-control" name="tujuan_penggunaan_kredit" onwheel="return false;" oninput="this.value = this.value.toUpperCase()" required />

                                                <label class="mt-2 mb-2">Jenis Jaminan</label><span class="ml-1" style="color:red;">*</span>
                                                <select name="jenis_jaminan" class="form-control" required>
                                                    <option value="" reaquired selected>- Silahkan Pilih -</option>
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control penghasilan_pasangan a14" id="4" name="penghasilan_pasangan" onkeypress="return hanyaAngka(event)" />
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="text" class="form-control" name="jumlah_kendaraan" onkeypress="return hanyaAngka(event)" oninput="this.value = this.value.toUpperCase()" />
                                                ...
                                                <input type="text" class="form-control" name="tahun_kendaraan" onkeypress="return hanyaAngka(event)" maxlength="4" oninput="this.value = this.value.toUpperCase()" />
                                ...
                                <h1 class="h4 mb-0"><strong>Konfirmasi</strong></h1>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <textarea name="catatan_cs" class="form-control h-25" rows="5" placeholder="" oninput="this.value = this.value.toUpperCase()"></textarea>
                            ...
                            <button id="btn_form_cs_simpan_data_kredit" type="submit" class="btn btn-primary btn-lg">Simpan</button>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.date2').val(moment().format("D/MM/YYYY"))
    ...
    <!-- Alert simpan permohonan kredit -->
    <script>
    ...
    <!-- Alert button batal input kredit -->
    <script>
