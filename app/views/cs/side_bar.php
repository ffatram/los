...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        JOIN tbl_wawancara B ON A.no_permohonan_kredit = B.no_permohonan_kredit WHERE A.kode_cabang =:kode_cabang AND B.status LIKE '%DIPENDING%' AND A.id_analis = :id_analis ORDER BY A.tanggal_permohonan DESC");
                ...
                <?php
                if ($_COOKIE['level'] == "PENCAIRAN") {
                ?>

                    <li class="nav-item">
                        <a href="<?= BASEURL ?>/pencairan/beranda" class="nav-link">
                            <i class="nav-icon fas fa-home"></i>
                            <p>
                                Beranda
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="<?= BASEURL ?>/pencairan/daftar_belum_pencairan" class="nav-link">
                            <i class="nav-icon fas fa-file-signature"></i>
                            <p>

                                <?php

                                $jumlah = $this->model('m_pencairan')->jumlah_daftar_belum_pencairan();


                                ?>
                                Daftar Belum Pencairan (<?= $jumlah ?>)
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= BASEURL ?>/pencairan/daftar_sudah_pencairan" class="nav-link">
                            <i class="nav-icon fas fa-folder-open"></i>
                            <p>
                                Daftar Sudah Pencairan
                            </p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="<?= BASEURL ?>/pencairan/inquiry" class="nav-link">
                            <i class="nav-icon fas fa-list-alt"></i>
                            <p>
                                Daftar Permohonan
                            </p>
